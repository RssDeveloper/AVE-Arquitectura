<section id="fh5co-servicios" class="fh5co-section" style="padding: 100px 0; background: #fafafa;">
    <div class="container">
        <div class="row">
            <div class="col-md-12 fh5co-heading animate-box text-center">
                <span class="project-tag">Especialidades</span>
                <h2 style="font-size: 38px; margin-bottom: 15px;">Servicios &amp; Soluciones</h2>
                <p style="max-width: 680px; margin: 0 auto; color: #666; font-size: 15px; line-height: 1.7;">
                    Acompañamos a despachos, profesionales independientes y estudiantes en cada etapa de su flujo de trabajo arquitectónico.
                </p>
            </div>
        </div>
