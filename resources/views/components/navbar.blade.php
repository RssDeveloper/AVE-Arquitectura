    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center logo-wrap">
                <div id="fh5co-logo">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('images/ave/logo.png') }}" alt="AVE Logo">AVE<span>.</span>
                    </a>
                </div>
            </div>
            <div class="col-xs-12 text-center menu-1 menu-wrap">
                <ul>
                    ...
                    <li><a href="{{ url('/#fh5co-about') }}">Sobre AVE</a></li>
                    <li><a href="{{ url('/#fh5co-proyectos') }}">Proyectos</a></li>
                    <li><a href="{{ url('/#fh5co-servicios') }}">Servicios</a></li>
                    <li><a href="{{ url('/#fh5co-cursos') }}">Cursos</a></li>
                    <li><a href="{{ url('/#fh5co-contacto') }}">Contacto</a></li>
                    <li>
